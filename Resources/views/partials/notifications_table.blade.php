...
<td>
    {{ __('Someone gives a thumbs up on your note in an internal conversation') }}
</td>
<td class="subs-cb subscriptions-email"><input type="checkbox" @include('users/is_subscribed', ['medium' => App\Subscription::MEDIUM_EMAIL, 'event' => \InternalConversations::EVENT_IC_THUMBS_UP]) name="{{ $subscriptions_formname }}[{{ App\Subscription::MEDIUM_EMAIL }}][]" value="{{ \InternalConversations::EVENT_IC_THUMBS_UP }}"></td>
<td class="subs-cb subscriptions-browser"><input type="checkbox" @include('users/is_subscribed', ['medium' => App\Subscription::MEDIUM_BROWSER, 'event' => \InternalConversations::EVENT_IC_THUMBS_UP]) name="{{ $subscriptions_formname }}[{{ App\Subscription::MEDIUM_BROWSER }}][]" value="{{ \InternalConversations::EVENT_IC_THUMBS_UP }}"></td>
<td class="subs-cb subscriptions-mobile"><input type="checkbox" @include('users/is_subscribed', ['medium' => App\Subscription::MEDIUM_MOBILE, 'event' => \InternalConversations::EVENT_IC_THUMBS_UP]) name="{{ $subscriptions_formname }}[{{ App\Subscription::MEDIUM_MOBILE }}][]" @if (!$mobile_available) disabled="disabled" @endif value="{{ \InternalConversations::EVENT_IC_THUMBS_UP }}"></td>
@action('notifications_table.td', \InternalConversations::EVENT_IC_THUMBS_UP, $subscriptions_formname, $subscriptions)
</tr>
